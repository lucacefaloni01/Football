class irene4_0:
    class dati:
        ...
        def update_PermierLigue():#da fare :
            import pandas as pd
            #######Arsenal##########
    ...
    class import_seriea:
        ...
        def Atalanta():
            import pandas as pd
            Atalanta = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Atalanta.csv')
            return Atalanta
        def Bologna():
            import pandas as pd
            Bologna = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Bologna.csv')
            return Bologna 
        def Cremonese():
            import pandas as pd 
            Cremonese = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Cremonese.csv')
            return Cremonese
        def Empoli():
            import pandas as pd 
            Empoli = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Empoli.csv')
            return Empoli
        def Fiorentina():
            import pandas as pd 
            Fiorentina = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Fiorentina.csv')
            return Fiorentina
        def HellasVerona():
            import pandas as pd
            HellasVerona = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/HellasVerona.csv')
            return HellasVerona
        def Inter():
            import pandas as pd
            Inter = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Inter.csv')
            return Inter
        def Juventus():
            import pandas as pd
            Juventus = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Juve.csv')  
            return Juventus
        def Lazio():
            import pandas as pd
            Lazio = pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Lazio.csv')
            return Lazio
        def Lecce():
            import pandas as pd 
            Lecce= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Lecce.csv')
            return Lecce
        def Milan():
            import pandas as pd 
            Milan= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Milan.csv')
            return Milan
        def Monza():
            import pandas as pd 
            Monza= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Monza.csv')
            return Monza
        def Napoli():
            import pandas as pd

            Napoli= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Napoli.csv')
            return Napoli
        def Roma():
            import pandas as pd
            Roma= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Roma.csv')
            return Roma 
        def Salernitana():
            import pandas as pd 
            Salernitana= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Salernitana.csv')
            return Salernitana
        def Sampdoria():
            import pandas as pd 
            Sampdoria= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Sampdoria.csv')
            return Sampdoria
        def Sassuolo():
            import pandas as pd
            Sassuolo= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Sassuolo.csv')
            return Sassuolo
        def Spezia():
            import pandas as pd 
            Spezia= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Spezia.csv')
            return Spezia
        def Torino():
            import pandas as pd 
            Torino= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Torino.csv')
            return Torino
        def Udinese():
            import pandas as pd 
            Udinese= pd.read_csv('~/Desktop/irene3.0/Data/SerieA/Udinese.csv')
            return Udinese
    class analisi:
        #Librerie
        import pandas as pd
        ...
        |__| | _| `._____|_______||__| \__| |_______|____/ ______ \___/  
            ...
            print('*GRAFICI*')
            irene4_0.analisi.graph_diff(data1, data2)
            irene4_0.analisi.freq(data1, data2)
            print('*Differenza della mediana statistica tra reti fatte e reti subite')
            irene4_0.analisi.unopuntozero(data1, data2)
            print('*Probabilità del numero di gol *')
            print(irene4_0.analisi.irene2(data1, data2))

    def __init__():
        def menu():
                print("[1]Aggiornare dati")
                print("[2]Import Dataset")
                print("[3]Analisi Calcio")
                print("[0]Esci dal programma")
                option = int(input("Scegli cosa fare: "))
                while option != 0:
                    if option == 1:
                        irene4_0.dati.update_SerieA()
                        menu()
                    elif option == 2:
                        Atalanta = irene4_0.import_seriea.Atalanta()
                        Bologna = irene4_0.import_seriea.Bologna()
                        Cremonese= irene4_0.import_seriea.Cremonese()
                        Empoli= irene4_0.import_seriea.Empoli()
                        Fiorentina= irene4_0.import_seriea.Fiorentina()
                        HellasVerona= irene4_0.import_seriea.HellasVerona()
                        Inter= irene4_0.import_seriea.Inter()
                        Juventus= irene4_0.import_seriea.Juventus()
                        Lazio= irene4_0.import_seriea.Lazio()
                        Lecce= irene4_0.import_seriea.Lecce()
                        Milan= irene4_0.import_seriea.Milan()
                        Monza= irene4_0.import_seriea.Monza()
                        Napoli= irene4_0.import_seriea.Napoli()
                        Roma= irene4_0.import_seriea.Roma()
                        Salernitana= irene4_0.import_seriea.Salernitana()
                        Sampdoria= irene4_0.import_seriea.Sampdoria()
                        Sassuolo= irene4_0.import_seriea.Sassuolo()
                        Spezia= irene4_0.import_seriea.Spezia()
                        Torino= irene4_0.import_seriea.Torino()
                        Udinese= irene4_0.import_seriea.Atalanta()
                        print("Dati importati")
                        menu()
                    elif option ==3:
                        Sq_casa = input("Squadra in casa: ")
                        Sq_away = input("Squadra furoicasa: ")
                        seriea = {"Atalanta" : Atalanta,
                         "Bologna" : Bologna,
                         "Cremonese" : Cremonese,    
                        "Empoli" : Empoli,
                        ...
                        "Torino" : Torino,
                        "Udinese" : Udinese}
                        irene4_0.analisi.analisi(seriea[Sq_casa], seriea[Sq_away])
                    else:
                        print("Opzione non valida")
                    menu
                    option = int(input("Scegli cosa fare: "))
                print("Grazie per avermi utilizzato, Arrivvederci")
        menu()
irene4_0.__init__()  
